...
\section{Theory}
Star formation at extreme surface densities and metallicities 
\subsection{Dust opacity effects}
\subsection{Effect of the interstellar radiation field}
The inter
\subsection{Stellar winds}

The energy in stellar winds from a stellar population is dominated by the most massive stars, and the winds of main-sequence massive stars are driven predominantly by Fe line opacity. We therefore expect that 
