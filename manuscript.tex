...
\begin{figure}
%	\includegraphics[width=0.5\textwidth]{figures/imf_plots/alphaplot_obs_chabrier_smooth_bounds.pdf}
...
\end{figure}
\begin{figure}
	\includegraphics[width=0.5\textwidth]{figures/VMS_M_vs_Mdot_M23.pdf}
\end{figure}
\begin{figure}
...
\section{Conclusion}
We have confirmed that the star formation efficiency on the scale of an individual GMC saturates to a value approaching unity at high surface density, {\it whilst accounting for all stellar feedback processes acting in concert from individual stars}.
