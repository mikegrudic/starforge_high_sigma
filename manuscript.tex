...
\begin{figure}
	...
	\caption{In observations, systematic uncertainties are significant for both quantities. Horizontal error bars for R136a1 convey the systematic uncertainty between the factor of $\sim 4$ different estimates in $M_{\rm cluster}$ quoted in \citet{weidner:2013.mmax.mecl.relation} and \citet{crowther:2010.r136.300msun}. The systematic uncertainty in $M_{\rm max}$ is illustrated by the range of quoted values for the probable most-massive known star R136a1, with quoted values ranging from $\sim 150M_\odot-300M_\odot$ \citep{massey:1998.r136.cluster.imf, crowther:2010.r136.300msun,schneider:2018.30dor.imf.excess,keszthelyi:2025.r136.evolutionary.models}, with \citet{higgins:2022.hydrogen.clock.vms} arguing that initial masses from $250-1000M_\odot$ may be observationally indistinguishable due to convergent mass-loss evolution. Inversely, accounting for the observed multiplicity of the system would revise this estimate downward \citep{kalari:2022.r136.multiplicity}. R136a1 is the best-studied case, but these issues would affect }
\end{figure}
